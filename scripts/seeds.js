...
const insertProblemLanguages = async () => {
    try {
        await pool.query(`INSERT INTO public.problem_languages (problem_id,language_id,initial_code,solution_code,full_code) VALUES
          (1,2,'class Solution {
         public:
     ...
     if __name__ == "__main__":
         ...
         def isMatch(self, s: str, p: str) -> bool:
             ...
             return dp[-1][-1]','#include <iostream>
         #include <string>
         #include <unordered_map>
